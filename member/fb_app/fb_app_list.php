...
<style>          
 ...
 <form name="search_frm" id="search_frm" method="post">
     ...
     <div class="table-responsive">	
        <table align="right">
              <TR>
                <TD  nowrap="nowrap">
                  <?php
                      $hash    =  getTableFieldsName("fb_app");
  ...
  <a href="index.php?cmd=edit"   class="btn btn-primary"><i class="fas fa-plus"></i> Add a FB app</a> <br><br>
