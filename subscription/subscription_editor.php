		         ...
		         <div class="table-responsive">	
	                <table class="table">
						 ...
						 <td>
		           		 ...
		           		 <td>Status</td>
				   		 <td><?php
	$enumsubscription = getEnumFieldValues('subscription','status');
?>
<select  name="status" id="status"   class="form-control-static">
<?php
   foreach($enumsubscription as $key=>$value)
   { 
?>
...
?> 
						 ...
						 <td>
						    <input type="text" name="date_subscribed" id="date_subscribed"  value="<?=$date_subscribed?>" class="datepicker form-control-static">
						 </td>
				     </tr>
										 <tr> 
											 <td align="right"></td>
