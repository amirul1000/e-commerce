     ...
     <div class="table-responsive">	
        <table align="right">
              <TR>
                <TD  nowrap="nowrap">
                  <?php
                      $hash    =  getTableFieldsName("home_page_category");
...
<a href="index.php?cmd=edit"   class="btn btn-primary"><i class="fas fa-plus"></i> Add a Home page category</a> <br><br>
                ...
                <table class="table table-bordered table-striped mb-0" id="datatable-default">
                    <tbody>
						 ...
						 <?php
								...
								$info["fields"] = array("home_page_category.*"); 
								$info["where"]   = "1   $whrstr ORDER BY display_position ASC  LIMIT $offset, $rowsPerPage";
							...
							<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
                              ...
                              <td>
		                            <?php
										...
										$res2  =  $db->select($info2);
										echo 'id:'.$res2[0]['id'].' '.$res2[0]['brand'].' '.$res2[0]['title'].' '.$res2[0]['name'];	
					                ?>
							   </td>
			                   <td><?=$arr[$i]['status']?></td>
			                   <td>
