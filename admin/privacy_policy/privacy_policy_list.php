     ...
     <div class="table-responsive">	
        <table align="right">
              <TR>
                <TD  nowrap="nowrap">
                  <?php
                      $hash    =  getTableFieldsName("privacy_policy");
...
<a href="index.php?cmd=edit"   class="btn btn-primary"><i class="fas fa-plus"></i> Add a privacy policy</a> <br><br>
                ...
                <table class="table table-bordered table-striped mb-0" id="datatable-default">
                    <tbody>
						 ...
						 <?php
								...
								$info["table"] = "privacy_policy";
								$info["fields"] = array("privacy_policy.*"); 
