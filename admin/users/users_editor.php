                        ...
                        <table  class="table table-bordered table-striped mb-0" id="datatable-default">
                             ...
                             <tr>
                              ...
                              <tr>
                                 <td>Created At</td>
                                 <td>
                                    <input type="text" name="created_at" id="created_at"  value="<?=$created_at?>" class="datepicker form-control">
                                 </td>
                             </tr>
                             <tr>
                                 <td>Updated At</td>
                                 <td>
                                    <input type="text" name="updated_at" id="updated_at"  value="<?=$updated_at?>" class="datepicker form-control">
                                 </td>
                             </tr>
                             -->
                             <tr>
