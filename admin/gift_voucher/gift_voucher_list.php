     ...
     <div class="table-responsive">	
        <table align="right">
              <TR>
                <TD  nowrap="nowrap">
                  <?php
                      $hash    =  getTableFieldsName("gift_voucher");
...
<a href="index.php?cmd=edit"   class="btn btn-primary"><i class="fas fa-plus"></i> Add a gift voucher</a> <br><br>
                ...
                <table class="table table-bordered table-striped mb-0" id="datatable-default">
                    <tbody>
						 ...
						 <?php
								...
								$info["table"] = "gift_voucher";
								$info["fields"] = array("gift_voucher.*"); 
