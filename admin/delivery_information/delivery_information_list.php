     ...
     <div class="table-responsive">	
        <table align="right">
              <TR>
                <TD  nowrap="nowrap">
                  <?php
                      $hash    =  getTableFieldsName("delivery_information");
...
<a href="index.php?cmd=edit"   class="btn btn-primary"><i class="fas fa-plus"></i> Add a delivery information</a> <br><br>
                ...
                <table class="table table-bordered table-striped mb-0" id="datatable-default">
                    <tbody>
						 ...
						 <?php
								...
								$info["fields"] = array("delivery_information.*"); 
