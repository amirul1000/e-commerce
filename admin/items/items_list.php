...
?>
<a href="index.php?cmd=edit" class="btn green"><i class="fa fa-plus-circle"></i> Add a <?=ucwords(str_replace("_"," ","items"))?></a> <br><br>
				                ...
				                <table align="right">
									  <TR>
										...
										<td nowrap="nowrap" align="right">
										  <input type="hidden" name="cmd" id="cmd" value="search_items" >
							...
							<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
							  <td>
		                            <?php
									    unset($info2);        
										$info2['table']    = orders;	
										$info2['fields']   = array("order_number");	   	   
										$info2['where']    =  "1 AND id='".$arr[$i]['orders_id']."' LIMIT 0,1";
										$res2  =  $db->select($info2);
										echo $res2[0]['order_number'];	
					                ?>
							   </td>
			  <td><?=$arr[$i]['os0']?></td>
			  <td><?=$arr[$i]['os1']?></td>
