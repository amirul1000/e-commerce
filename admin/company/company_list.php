           ...
           <div class="portlet-title">
            ...
            <div class="portlet-body">
	         <div class="table-responsive">	
			  ...
			  <td><?=$arr[$i]['file_logo']?></td>
			  <td><?=$arr[$i]['business_type']?></td>
			  <td><?=$arr[$i]['main_products']?></td>
			  <td><?=$arr[$i]['total_annual_revenue']?></td>
			  <td><?=$arr[$i]['total_employees']?></td>
			  <td><?=$arr[$i]['year_established']?></td>
			  <td><?=$arr[$i]['social_link']?></td>
			  <td><?=$arr[$i]['email']?></td>
			  <td><?=$arr[$i]['cell_phone']?></td>
			  <td><?=$arr[$i]['land_phone']?></td>
			  <td>
		                            <?php
									    unset($info2);        
										$info2['table']    = country;	
			  ...
			  <td><?=$arr[$i]['country_txt']?></td>
			  <td><?=$arr[$i]['state']?></td>
			  <td><?=$arr[$i]['city_town']?></td>
			  <td><?=$arr[$i]['area']?></td>
