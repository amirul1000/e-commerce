  ...
  <div id="container">
    <div class="container">
      ...
      <ul class="breadcrumb">
        ...
        <li><a href="<?=$site_url?>/category"><?=trim($_REQUEST['category'])?></a></li>
      </ul>
      <!-- Breadcrumb End-->
      <div class="row">
        <!--Left Part Start -->
        ...
        <div id="content" class="col-sm-9">
          ...
          <div class="row products-category">
			...
			if($_SESSION["search"]=="yes")
			  ...
			  $whrstr .= " AND parent_category_txt LIKE '%".$_REQUEST['category']."%'";
              ...
              <div class="product-thumb">
                ...
                <div>
                  ...
                  <div class="button-group">
                    ...
                    <form name="frm_category_<?=$i?>" id="frm_category_<?=$i?>" action="" method="post">
                       ...
                       <input type="hidden" name="products_id" value="<?=$arr[$i]['id']?>">
                        <button class="btn-primary" type="button" onClick="formSubmit('frm_category_<?=$i?>');"><span>Add to Cart</span></button>
                    </form>
